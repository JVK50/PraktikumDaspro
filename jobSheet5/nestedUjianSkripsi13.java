    ...
    public static void main(String[] args) {
        ...
        if (bebasKompen.equalsIgnoreCase("Ya")) {
            if (bimbinganP1 >= 8 && bimbinganP2 >= 4) {
                ...
                System.out.println("Gagal! Log bimbingan P1 kurang dari 8 kali");
            } else {
                System.out.println("Gagal! Log bimbingan P2 kurang dari 4 kali");
            }    
        } else {
            System.out.println("Gagal! Mahasiswa masih punya tanggungan kompen");
        }
        sc.close();
    }
}
